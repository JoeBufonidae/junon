...
class Game {
  ...
  onInstallAttachment(data) {
    // Just send the request to the server
    SocketUtil.emit("InstallAttachment", data)
  }

  onRemoveAttachment(data) {
    SocketUtil.emit("RemoveAttachment", data)
  }
