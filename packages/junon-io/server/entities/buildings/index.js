...
Buildings.SmallAirlock = require("./small_airlock")
...
// Buildings.Wall3d = require("./wall3d")
Buildings.UnbreakableWall = require("./unbreakable_wall")
Buildings.Beacon = require("./beacon")
Buildings.Cage = require("./cage")
Buildings.Window = require("./window")
Buildings.ArmoredWindow = require("./armored_window")
Buildings.LowWall = require("./low_wall")
...
Buildings.SmallWoodTable = require("./small_wood_table")
...
Buildings.SuitWorkstation = require("./suit_workstation")
Buildings.SuitReconstructor = require("./suit_reconstructor")
...
Buildings.CircuitBoardPrinter = require("./circuit_board_printer")
...
Buildings.Revitalizer = require("./towers/revitalizer")
...
Buildings.CabbageSeed = require("./crops/cabbage_seed")
